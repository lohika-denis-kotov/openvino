    ...
    INSTANTIATE_TEST_SUITE_P(smoke_TensorIteratorCommon, TensorIteratorWithConfigTest,
        ::testing::Combine(
            ...
            ::testing::ValuesIn(std::vector<Config> {
                {CommonTestUtils::DEVICE_OCL, {{GPUConfigParams::KEY_GPU_ENABLE_LOOP_UNROLLING, PluginConfigParams::YES}}},
                {CommonTestUtils::DEVICE_OCL, {{GPUConfigParams::KEY_GPU_ENABLE_LOOP_UNROLLING, PluginConfigParams::NO}}}
            })), // configuration
